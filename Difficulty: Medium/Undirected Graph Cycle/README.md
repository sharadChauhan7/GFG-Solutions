...
<p><span style="font-size: 14pt;">You don't have to read or print anything. Complete the function <strong>isCycle()&nbsp;</strong>which takes <strong>V</strong> and adjacency list <strong>adj[]</strong> and returns 0 or 1 depending whether the cycle&nbsp; is present or not.</span></p>
